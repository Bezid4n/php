...
$query3="SELECT * FROM nejad_animal WHERE nejad = '$nejad'";
$result3=mysqli_query($link,$query3);
$row3=mysqli_fetch_array($result3);
$code_nejad=$row3['code'];

$query="SELECT * FROM wildlife WHERE code_nejad='$code_nejad'";
 ...
 <table border="0" cellspacing="1" width="90%" align="center" cellpadding="2">
  <caption align="center" dir="rtl" valign="top">
   <font size="3" face="Courier New, Courier, monospace" color="#FF6600">
    <b>جستجو بر اساس نژاد حیوان : <?php echo $nejad;?> و نوع حیوان : <?php echo $type;?></b></font>
