...
<?php
 include("php/db.php");
  ...
  $query="SELECT * FROM `wildlife` where code_ostan='30'";
  $result=mysqli_query($link,$query);
  ?>
<body>
 <table border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr>
   <td width="20%"><img src="pic/city/khozestan.gif" width="200" height="200" /></td>
   <td align="right" valign="top" width="80%">
    <font size="5" face="Courier New, Courier, monospace" color="#FF6600"><b>استان خوزستان</b></font>
   </td>
  </tr>
  <tr>
   <td colspan="2">
