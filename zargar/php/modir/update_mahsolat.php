...
if($_POST['name']==null)
	...
	<script language="javascript" type="text/javascript">
		...
		window.location="manager.php?page_name=result_mahsolat";
		</script>
		<?php
		$ch=0;}
		if($_POST['fi']==null)
...
if(strlen($ayar)<> 3){
 ...
 $t_id=$row2['t_id'];
  ...
  $query3="select * from `mahsolat` where m_name='$name' and t_id='$t_id' and  m_id<>'$id'";
...
$query="UPDATE `mahsolat` SET `t_id` = '$t_id',`m_name` = '$name', m_ayar='$ayar',m_pic='$path2',m_fi='$fi',m_vazn='$vazn',m_date='$date' where m_id='$id'";
