...
$query="SELECT * FROM `tablighat` where id='$id'";
...
<body>
 ...
 <caption align="center" dir="rtl" valign="top">
  ...
  <tr>
   <td>
    <form action="update_tabligh.php?id=<?php echo $row['id'];?>" method="post" enctype="multipart/form-data" onsubmit="javascript:return check_form();">
