...
$id=$_GET['id'];
$query="SELECT * FROM `baner` where code='$id'";
...
<body>
 ...
 <caption align="center" dir="rtl" valign="top">
   <font face="Courier New" size="2"><b>ویرایش بنر</b></font>
   <hr align="center" size="2" color="#999999" />
  </caption>
  <tr>
   <td>
    <form action="update_baner.php?id=<?php echo $row['code'];?>" method="post" enctype="multipart/form-data" onsubmit="javascript:return check_form();">
    <table border="0" cellspacing="0" width="100%">
	 <tr>
	   <td align="right" width="65%" dir="rtl">
		<input name="name" size="30" dir="ltr" type="text" value="<?php echo $row['title']?>"/></td>
	   <td align="left"><font face="Tahoma, Arial" size="2" dir="rtl">عنوان عکس بنر :</font></td>
	 </tr>
	 <tr>
	   <td align="right" width="65%" dir="rtl">
