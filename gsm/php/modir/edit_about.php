...
$id=$_GET['id'];
$query="SELECT * FROM `about_me` where code='$id'";
...
<table border="0" cellspacing="1" width="90%" align="center" cellpadding="2">
  ...
  <tr>
   <td>
	<form action="update_about.php?id=<?php echo $row['code'];?>" method="post" enctype="multipart/form-data" onsubmit="javascript:return check_form();">
