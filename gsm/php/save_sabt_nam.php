...
<?php  } else {
$query="INSERT INTO sabt_nam (code,name_karbari,pass,name,family,day,moth,year,sex,email,address)
        VALUES           	('','$name_karbari','$pass','$name','$family','$day','$moth','$year','$sex','$email','$address')";	 
